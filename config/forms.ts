...
export const emailSchema = z.string().min(1, { message: "This field is required." }).email("This is not a valid email.")
export const requiredString = (field: string) => z.string().min(1, { message: `${field} is required.` })
