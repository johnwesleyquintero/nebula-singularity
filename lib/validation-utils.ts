...
export const validationHelpers = {
  isValidEmail: (email: string) => validationPatterns.email.safeParse(email).success,
  isValidPhone: (phone: string) => validationPatterns.phoneNumber.safeParse(phone).success,
  isValidUrl: (url: string) => validationPatterns.url.safeParse(url).success,
  isValidCurrency: (amount: number) => validationPatterns.currency.safeParse(amount).success,
  isValidPassword: (password: string) => validationPatterns.password.safeParse(password).success
}