...
class MarketplaceAPI {
  ...
  async getKeywordMetrics(keywords: string[]): Promise<KeywordData[]> {
    return this.fetchWithRetry<KeywordData[]>("/keywords/metrics", {
      method: "POST",
  ...
  async getPPCMetrics(
    ...
    return this.fetchWithRetry(`/ppc/campaigns/${campaignId}/metrics`, {
      method: "POST",
  ...
  async validateListing(listing: {
    ...
    return this.fetchWithRetry("/listings/validate", {
      method: "POST",
