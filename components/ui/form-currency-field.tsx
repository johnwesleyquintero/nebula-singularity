...
interface FormCurrencyFieldProps extends React.InputHTMLAttributes<HTMLInputElement> {
  label?: string
  currency?: string
  error?: string
}

const FormCurrencyField = React.forwardRef<HTMLInputElement, FormCurrencyFieldProps>(
